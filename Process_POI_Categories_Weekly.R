...
# Set location of the Safegraph data
data_dir <- "C:/Users/ulric/OneDrive - University of North Carolina at Chapel Hill/Shared Documents - Safegraph_data/advan_sg/weekly_patterns_NC/advan_sg/weekly_patterns_NC/"
...
poi_file_list <- list.files(path = data_dir, pattern = "^NC_weeklypatterns_poi_info.*\\.csv$", full.names = TRUE)
