...
#shp_path <- "C:\\Users\\ulrichs\\AppData\\Local\\Temp\\RtmpeYXVGN/GIS.OFFICIAL_CLIM_DIVISIONS.shp"
    ...
    mutate(
      across(
        c(starts_with(paste0("above_tmean_pct_", p)), 
          ...
          starts_with(paste0("above_heatindex_pct_",p))),
        list(
...
write_parquet(df_heatwave, "Data/Temp/Clean/NC_CBG2010_Heatwaves.parquet") 
